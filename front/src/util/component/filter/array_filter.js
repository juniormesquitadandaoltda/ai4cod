...
export default class ArrayFilter extends ApplicationFilter {
  render = (_) => (
    <>
      <div className='mt-6'>
                ...
                <div key={index}>
                  <div className='flex'>
                    ...
                    <textarea
                      ...
                      className='rounded-none rounded-r-lg block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
                    ></textarea>
                  </div>
                  ...
                  <li className='w-full border-gray-200 dark:border-gray-600'>
                    <div className='flex items-center pl-3'>
                      ...
                      <label
                        ...
                        className='w-full p-5 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'
                      >
