# https://github.com/adzap/validates_timeliness/blob/v6.0.0.alpha1/lib/validates_timeliness/railtie.rb
module ValidatesTimeliness
  class Railtie < Rails::Railtie
    ...
    initializer 'validates_timeliness.initialize_timeliness_ambiguous_date_format',
