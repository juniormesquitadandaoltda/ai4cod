...
module STANDARD
  class ApplicationController < ::ActionController::Base
    ...
    attr_reader :current_subscription, :current_client
    ...
    def authorize_user!
      @current_subscription ||= current_user.subscriptions.first || current_user.collaborations.first&.subscription

      @current_client = current_subscription || current_user
