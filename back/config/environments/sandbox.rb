...
Rails.application.configure do
  ...
  # config.hosts = ActionDispatch::HostAuthorization::ALLOWED_HOSTS_IN_DEVELOPMENT + %w[.sandbox.ai4cod.com]
  config.hosts.push(*ENV['ALLOWED_HOSTS'].to_s.split(',')) # .sandbox.ai4cod.com,alb
