...
module ADMIN
  RSpec.describe NotificatorsPolicy, type: :policy do
    ...
    describe '#new' do
      it 'must be successful' do
        expect(access_admin).not_to receive(:exists?)
        expect(access_admin.send(:new)).to be_truthy
      end
    ...
    describe '#edit' do
      it 'must be successful' do
        expect(access_admin).to receive(:exists?).and_call_original
        expect(access_admin.send(:edit)).to be_truthy
      end
    ...
    describe '#create' do
      it 'must be successful' do
        expect(access_admin).not_to receive(:exists?)
        expect(access_admin.send(:create)).to be_truthy
      end
    ...
    describe '#update' do
      it 'must be successful' do
        expect(access_admin).to receive(:exists?).and_call_original
        expect(access_admin.send(:update)).to be_truthy
      end
    ...
    describe '#destroy' do
      it 'must be successful' do
        expect(access_admin).to receive(:exists?).and_call_original
        expect(access_admin.send(:destroy)).to be_truthy
      end
