...
module ADMIN
  RSpec.describe NotificatorsController, type: :controller do
    render_views

    let(:model) { create(:notificator) }

    describe '.constants' do
      it { expect(described_class::FILTER).to eq(NotificatorsFilter) }
    ...
    describe 'POST create' do
      it '.json success' do
        attributes = attributes_for(:notificator)
    ...
    describe 'DELETE destroy' do
      ...
      it '.json unprocessable_entity' do
        create(:notification, notificator: model)
