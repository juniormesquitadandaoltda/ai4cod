...
RSpec::Matchers.define :standard_search_attributes do |search_attributes|
  match do |instance|
    @instance = instance
  ...
  def key_accessor(attribute)
    ...
    instance.assign_attributes(current_user:, current_subscription:,
                               sort: attribute.to_s, order: 'asc', page: 1, limit: 100, attribute => '')
    raise "#{attribute} should be search (#{instance.errors.messages})" unless instance.search

    instance.assign_attributes(current_user:, current_subscription:,
                               sort: attribute.to_s, order: 'asc', page: 1, limit: 100, attribute => 'a')
    raise "#{attribute} should be search (#{instance.errors.messages})" unless instance.search
  ...
  def string_accessor(attribute)
    ...
    [attribute, attribute_in].each do |a|
      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, a => '')
      raise "#{a} should be search (#{instance.errors.messages})" unless instance.search

      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, a => 'a')
      raise "#{a} should be search (#{instance.errors.messages})" unless instance.search
  ...
  def enum_accessor(attribute)
    ...
    described_class::MODEL.send(attribute.to_s.pluralize).each_key do |value|
      ...
      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, attribute => value)
      raise "#{attribute} should be search (#{instance.errors.messages})" unless instance.search
  ...
  def bigint_accessor(attribute)
    ...
    [attribute, attribute_gt, attribute_gte, attribute_lt, attribute_lte].each do |a|
      ...
      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, a => 0)
      raise "#{a} should be search (#{instance.errors.messages})" unless instance.search
  ...
  def decimal_accessor(attribute)
    ...
    [attribute, attribute_gt, attribute_gte, attribute_lt, attribute_lte].each do |a|
      ...
      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, a => 0.0)
      raise "#{a} should be search (#{instance.errors.messages})" unless instance.search
  ...
  def timeliness_accessor(attribute:, type:)
    ...
    [attribute, attribute_gt, attribute_gte, attribute_lt, attribute_lte].each do |a|
      ...
      instance.assign_attributes(current_user:, current_subscription:,
                                 sort: attribute.to_s, order: 'asc', page: 1, limit: 100, a => value)
      raise "#{a} should be search (#{instance.errors.messages})" unless instance.search
